...
//a click event handler is added on the cart buttons that allows them to open the cart component
...
//adds an onclick event handler to the closeCartBtn element to remove the show class thereby closing the cart element
closeCartBtn.onclick = () => {
  cartContainer.classList.remove("show");//the show class is removed when the closeCart button is clicked
};
...
//keeps track of the amount of items in the shopping cart and updates the UI when the items change
...
//the displayCart function dynamically displays all the items in the shopping cart
