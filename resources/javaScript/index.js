//required variables to access elements in the DOM
...
//adds an eventListener to the burgerMenu element to open the menu when it is clicked
burgerMenu.onclick = () => {
...
closeLinks.onclick = () => {
  //access the "active" class by using the remove method on the classList object
