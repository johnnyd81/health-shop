...
//closes the cart by removing the active class from the element's classlist
function closeCart() {
...
closeLinks.onclick = () => {
  closeCart(); // closeCart function is called when the closeLinks element is clicked
};
